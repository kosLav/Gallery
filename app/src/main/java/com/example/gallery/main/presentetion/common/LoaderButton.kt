package com.example.gallery.main.presentetion.common
...
import com.example.gallery.databinding.LoaderButtonViewBinding

class LoaderButton @JvmOverloads constructor(context: Context, attributeSet: AttributeSet? = null) : FrameLayout(context, attributeSet){
